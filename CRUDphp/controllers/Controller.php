...
class Controller {
    ...
    public function editarEstudante() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $this->model->editarEstudante($idEstudante, $novoNomeEstudante, $matriculaEstudante, $cursoEstudante, $anoIngresso);
        }
    }
    ...
    public function editarResponsavel() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $this->model->editarResponsavel($idEstudante, $oldNameParent, $newNameParent, $kinshipParent, $contactParent);
        }
    }
