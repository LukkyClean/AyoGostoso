...
class Model {
    ...
    public function salvarEstudante($matricula, $nomeAluno, $curso, $ano_ingresso, $nomeResponsavel, $contatoResponsavel, $parentescoResponsavel){
        try {
    ...
    public function buscarEstudantes() {
        try {
            $stmt = $this->connect->prepare("SELECT id, matricula, nome, curso, ano_ingresso FROM estudantes WHERE nome like nome ");
            $stmt->execute();
