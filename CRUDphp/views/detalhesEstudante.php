                    ...
                    <div class="description">
                        <form id="studentForm" class="content" action="router.php?rota=editarEstudante" method="POST">
                            ...
                            <div class="data-edit">
                                ...
                                <input type="text" id="matricula-edit" name="matriculaEstudante" value="<?=htmlspecialchars($matriculaEstudante)?>" placeholder="99999999" minlength="8" maxlength="8" required>
                            </div>
                            <div class="data-edit">
                                ...
                                <div class="description">
                                    <form id="parentForm" class="content">
                                        <div class="data-edit">
                                            ...
                                            <input type="text" id="cell-parent-edit" value="<?=htmlspecialchars($responsavel->contato)?>" placeholder="(88) 99999-9999" minlength="15" maxlength="15" required>
                                        </div>
                                        <div class="data-edit">
                                            <label for="nome-edit">Nome: </label>
                                            <input type="text" id="name-parent-edit" value="<?=htmlspecialchars($responsavel->nome)?>" placeholder="Digite um nome" maxlength="100" required>
                                        </div>
                                        <div class="data-edit">
